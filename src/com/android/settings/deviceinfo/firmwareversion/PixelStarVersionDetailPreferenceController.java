...
public class PixelStarVersionDetailPreferenceController extends BasePreferenceController {
    ...
    public PixelStarVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        ...
        if (fullRomVersion) {
            ...
            preference.setSummary(SystemProperties.get(KEY_PIXELSTAR_RELEASE_VERSION_PROP,
